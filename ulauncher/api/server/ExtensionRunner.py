...
class ExtensionRunner:
    ...
    def handle_stderr(self, error_stream, result, extension_id):
        output, outlen = error_stream.read_line_finish(result)
        if output:
            print(output.decode())
    ...
    def handle_wait(self, subprocess, result, extension_id):
        status = subprocess.wait_finish(result)
    ...
    def stop(self, extension_id):
        ...
        GLib.timeout_add(GLib.PRIORITY_DEFAULT, 500, self.confirm_termination, extproc)
